...
$this->API->addCSS($this->API->URLtemplate() . '/css/meanmenu.min.css');
...
$this->API->addCSS($this->API->URLtemplate() . '/jquery-ui/jquery-ui.min.css');
...
$this->API->addJS($this->API->URLtemplate() . '/jquery-ui/jquery-ui.min.js');
$this->API->addJS($this->API->URLtemplate() . '/js/jquery.meanmenu.min.js');
$this->API->addJS('https://maps.googleapis.com/maps/api/js?v=3.exp');
$this->API->addJS($this->API->URLtemplate() . '/js/gk.scripts.js');
$this->API->addJS($this->API->URLtemplate() . '/js/gk.menu.js');
//$this->API->addJS('http://vk.com/js/api/share.js?90');
$this->API->addJS('//vk.com/js/api/openapi.js?101');
