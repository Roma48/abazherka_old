...
class modJUMenuHelper
{
	...
	private static function build30()
	{
		...
		$out .= '<li><a href="'.$site.'forum/" target="_blank">Підтримка Joomla! Україна</a></li><li><a href="'.$site.'forum/viewforum.php?f=188" target="_blank">Форум підтримки Joomla 3.x</a></li>';
